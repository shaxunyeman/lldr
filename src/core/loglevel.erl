%% @author Li Liang	<liliang@4399.com>
%% @since 2011-12-6
%% @copyright 2011 web.4399.com
%% @doc	The logger module.
...
%% @doc Set log Level. The logger module is compiled and loaded dynamically.
